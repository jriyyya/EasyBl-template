// types
import { Service } from '../../(protected)/landing/crypto/types'

const Benefits = ({ services }: { services: Service[] }) => {
  return (
    <section className="py-20">
      <div className="container">
        <div className="text-center">
          <h1 className="text-3xl font-medium">The Benefits</h1>
          <p className="font-medium text-slate-500 mt-5 mb-4">
            of using the EasyBL platform
          </p>
        </div>

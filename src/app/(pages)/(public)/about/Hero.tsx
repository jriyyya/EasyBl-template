...
Welcome to  &nbsp;
              <span className="relative z-0 after:bg-primary/30 after:-z-10 after:absolute md:after:h-6 sm:after:h-5 after:h-4 after:w-full after:bottom-0 after:end-0">EasyBL
              </span>
              &nbsp; - Transformative Solutions for Modern Trade
            </h1>
            <p className="sm:text-lg text-gray-500 px-12">
      We redefine the landscape of trade with innovative solutions tailored for the modern era.
            </p>
          </div>
        </div>
      </section>
